...
namespace Drupal\Tests\druki_content\Unit\EventSubscriber;
 ...
 */
final class ContentSourceEventSubscriberTest extends UnitTestCase {
  ...
  protected function buildContentSyncQueueBuilder(): ContentSyncQueueBuilderInterface {
    ...
    $queue_manager->buildFromPath(Argument::any())->will(static function () use ($self): void {
  ...
  protected function buildGit(): GitInterface {
    ...
    $process->isSuccessful()->will(static function () use ($process) {
