...
namespace Drupal\Tests\druki_content\ExistingSite\Plugin\DataType;
 ...
 *
 * @coversDefaultClass DocumentationMetadataInterface
 */
final class DocumentationMetadataTest extends ExistingSiteBase {
  ...
  public function testDataType(): void {
    ...
    /** @var \Drupal\druki_content\Plugin\DataType\DocumentationMetadataInterface $data_type */
