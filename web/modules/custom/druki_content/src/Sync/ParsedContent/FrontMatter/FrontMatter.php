...
final class FrontMatter {
   ...
   *
   * @param \Drupal\druki_content\Sync\ParsedContent\FrontMatter\FrontMatterValue $value
   *   The value.
   *
   * @return $this
   */
   ...
   *   The key to get.
   *
   * @return \Drupal\druki_content\Sync\ParsedContent\FrontMatter\FrontMatterValue|null
