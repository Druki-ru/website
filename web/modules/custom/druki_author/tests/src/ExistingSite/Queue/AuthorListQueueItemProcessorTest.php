...
namespace Drupal\Tests\druki_author\ExistingSite\Queue;
...
final class AuthorListQueueItemProcessorTest extends ExistingSiteBase {
  ...
  public function testProcessNotExistingAuthor(): void {
    vfsStream::setup();
    vfsStream::create([
      'avatar.jpg' => \file_get_contents(\DRUPAL_ROOT . '/core/tests/fixtures/files/image-2.jpg'),
    ]);
    ...
    $author = Author::createFromArray('test', [
      ...
      'image' => vfsStream::url('root/avatar.jpg'),
      'country' => 'RU',
      'identification' => [
        'email' => [
