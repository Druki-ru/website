...
namespace Drupal\Tests\druki_author\ExistingSite\Plugin\Field\FieldFormatter;
...
final class AvatarFormatterTest extends ExistingSiteBase {
  ...
  public function testFormatter(): void {
    ...
    \file_put_contents($file->getFileUri(), \file_get_contents(\DRUPAL_ROOT . '/core/tests/fixtures/files/image-2.jpg'));
    $file->save();
