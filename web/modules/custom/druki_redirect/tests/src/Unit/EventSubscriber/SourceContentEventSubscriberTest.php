...
namespace Drupal\Tests\druki_redirect\Unit\EventSubscriber;
 ...
 */
final class SourceContentEventSubscriberTest extends UnitTestCase {
   ...
   *
   * @return \Drupal\druki_redirect\Builder\RedirectSyncQueueBuilderInterface
   *   The mock instance.
   */
  protected function buildRedirectSyncQueueBuilder(): RedirectSyncQueueBuilderInterface {
    ...
    $queue_manager->buildFromDirectories(Argument::any())->will(static function ($args) use ($self): void {
