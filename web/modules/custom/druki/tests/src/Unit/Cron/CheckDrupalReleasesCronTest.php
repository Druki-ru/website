...
namespace Drupal\Tests\druki\Cron;
...
final class CheckDrupalReleasesCronTest extends UnitTestCase {
  ...
  public function testDataStillValid(): void {
    $time = $this->buildTimeService(979_516_800);
  ...
  protected function buildDrukiDrupalReleases(array $initial_values): DrupalCoreVersionInterface {
    ...
    $drupal_releases->set(Argument::type('array'))
      ->will(static function ($args) use ($drupal_releases): void {
